...
#include "gemm-microkernel-tester.h"
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
      ...
      .n(8)
      .k(8)
      .test(q8gemm_ukernel_4x8__aarch32_neon_per_channel);
  }

  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_strided_a_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_strided_c_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_qmin128_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_qmax128_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_azp0_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_bzp0_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_eq_8_nozp_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_strided_a_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_strided_c_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_azp0_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_bzp0_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_nozp_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_gt_8_subtile_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_div_8_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_div_8_strided_a_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_div_8_strided_c_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL, k_div_8_subtile_per_channel) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 24) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
      ...
      .k(8)
      .use16bitAcc(true)
      .test(q8gemm_ukernel_4x8__aarch32_neon_per_channel_16bitAcc);
  }

  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_strided_c) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_qmin128) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_qmax128) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_azp0) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_bzp0) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_eq_8_nozp) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8_strided_c) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8_azp0) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8_bzp0) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8_nozp) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_gt_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_div_8) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_div_8_strided_a) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_div_8_strided_c) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__AARCH32_NEON_PER_CHANNEL_16BIT, k_div_8_subtile) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 24) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  // Q8GEMM 4X8 NEON PER CHANNEL - START
  ...
  // Q8GEMM 4X8 NEON PER CHANNEL - END

  // Q8GEMM 4X8 NEON PER CHANNEL 16 BIT - START
  TEST(Q8GEMM_4x8__NEON, k_eq_8_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
      ...
      .k(8)
      .use16bitAcc(true)
      .test(q8gemm_ukernel_4x8__neon_per_channel_16bitAcc);
  }

  TEST(Q8GEMM_4x8__NEON, k_eq_8_strided_a_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_eq_8_strided_c_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_eq_8_qmin128_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_eq_8_qmax128_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_eq_8_azp0_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_eq_8_bzp0_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_eq_8_nozp_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    GemmMicrokernelTester()
      .mr(4)
      .nr(8)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_strided_a_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_strided_c_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_azp0_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_bzp0_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_nozp_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_gt_8_subtile_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 9; k < 16; k++) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  TEST(Q8GEMM_4x8__NEON, k_div_8_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_div_8_strided_a_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_div_8_strided_c_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 8) {
      GemmMicrokernelTester()
        .mr(4)
  ...
  TEST(Q8GEMM_4x8__NEON, k_div_8_subtile_per_channel_16bitAcc) {
    TEST_REQUIRES_ARM_NEON;
    for (size_t k = 16; k < 128; k += 24) {
      for (uint32_t m = 1; m <= 4; m++) {
        for (uint32_t n = 1; n <= 8; n++) {
  ...
  }// Q8GEMM 4X8 NEON PER CHANNEL 16 BIT - END
#endif
