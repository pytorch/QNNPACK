    ...
    const union qnnp_conv_quantization_params quantization_params[RESTRICT_STATIC 1])
{
  ...
  do {
    ...
    for (; c >= 8; c -= 8) {
      ...
      const __m128i vxi0 = sub_zero_point(_mm_unpacklo_epi8(vi0, vzero), va_zero_point);
      ...
      const __m128i vxi1 = sub_zero_point(_mm_unpacklo_epi8(vi1, vzero), va_zero_point);
      ...
      const __m128i vxi2 = sub_zero_point(_mm_unpacklo_epi8(vi2, vzero), va_zero_point);
      ...
      const __m128i vxi3 = sub_zero_point(_mm_unpacklo_epi8(vi3, vzero), va_zero_point);
      ...
      const __m128i vxi4 = sub_zero_point(_mm_unpacklo_epi8(vi4, vzero), va_zero_point);
      ...
      const __m128i vxi5 = sub_zero_point(_mm_unpacklo_epi8(vi5, vzero), va_zero_point);
      ...
      const __m128i vxi6 = sub_zero_point(_mm_unpacklo_epi8(vi6, vzero), va_zero_point);
      ...
      const __m128i vxi7 = sub_zero_point(_mm_unpacklo_epi8(vi7, vzero), va_zero_point);
      ...
      const __m128i vxi8 = sub_zero_point(_mm_unpacklo_epi8(vi8, vzero), va_zero_point);
    ...
    if (c != 0) {
      ...
      const __m128i vi7 = _mm_srl_epi64(_mm_loadl_epi64((const __m128i*) i7), vi_shift);
      const __m128i vxi7 = sub_zero_point(_mm_unpacklo_epi8(vi7, vzero), va_zero_point);
      const __m128i vk7 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 88));
      const __m128i vxk7 = _mm_sub_epi16(_mm_unpacklo_epi8(vk7, vzero), vkernel_zero_point);
      const __m128i vprod7_odd  = _mm_mullo_epi16(vxi7, vxk7);
      ...
      const __m128i vi8 = _mm_srl_epi64(_mm_loadl_epi64((const __m128i*) i8), vi_shift);
      const __m128i vxi8 = sub_zero_point(_mm_unpacklo_epi8(vi8, vzero), va_zero_point);
      const __m128i vk8 = _mm_loadl_epi64((const __m128i*) ((uintptr_t) w + 96));
      const __m128i vxk8 = _mm_sub_epi16(_mm_unpacklo_epi8(vk8, vzero), vkernel_zero_point);
      const __m128i vprod8_odd  = _mm_mullo_epi16(vxi8, vxk8);
