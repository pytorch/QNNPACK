    ...
    const union qnnp_conv_quantization_params quantization_params[restrict static 1])
{
  ...
  for (; k >= 8; k -= 8) {
    ...
    const int16x8_t vxa0 = vreinterpretq_s16_u16(vsubl_u8(va0, va_zero_point)); a0 += 8;
    const uint8x8_t va1 = vld1_u8(a1);
    const int16x8_t vxa1 = vreinterpretq_s16_u16(vsubl_u8(va1, va_zero_point)); a1 += 8;
    const uint8x8_t va2 = vld1_u8(a2);
    const int16x8_t vxa2 = vreinterpretq_s16_u16(vsubl_u8(va2, va_zero_point)); a2 += 8;
    const uint8x8_t va3 = vld1_u8(a3);
    const int16x8_t vxa3 = vreinterpretq_s16_u16(vsubl_u8(va3, va_zero_point)); a3 += 8;
    const uint8x8_t va4 = vld1_u8(a4);
    const int16x8_t vxa4 = vreinterpretq_s16_u16(vsubl_u8(va4, va_zero_point)); a4 += 8;
    const uint8x8_t va5 = vld1_u8(a5);
    const int16x8_t vxa5 = vreinterpretq_s16_u16(vsubl_u8(va5, va_zero_point)); a5 += 8;
    const uint8x8_t va6 = vld1_u8(a6);
    const int16x8_t vxa6 = vreinterpretq_s16_u16(vsubl_u8(va6, va_zero_point)); a6 += 8;
    const uint8x8_t va7 = vld1_u8(a7);
    const int16x8_t vxa7 = vreinterpretq_s16_u16(vsubl_u8(va7, va_zero_point)); a7 += 8;
